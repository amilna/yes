...
/**
 * PaymentSearch represents the model behind the search form about `amilna\yes\models\Payment`.
 */
class PaymentSearch extends Payment
{
	...
	{
		return parent::find()->where([Payment::tableName().'.isdel' => 0]);
	}
    ...
    public function search($params)
    {
        ...
        $params = self::queryString([['terminal'],['account'],['name']/*['id','{{%confirmations}}']*/]);
		foreach ($params as $p)
		{
			$query->andFilterWhere($p);
		}
