...
class ShippingSearch extends Shipping
{
    ...
    public function rules()
    {
        return [
            [['id',  'isdel'], 'integer'],
            [['status','code', 'city', 'area', 'data', 'term' ], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
		...
		$query->andFilterWhere(["OR","lower(code) like '%".strtolower($this->term)."%'",["OR","lower(area) like '%".strtolower($this->term)."%'","lower(city) like '%".strtolower($this->term)."%'"]]);
